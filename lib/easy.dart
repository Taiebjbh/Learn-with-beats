              ...
              children: <Widget>[
                ...
                Container(
                  child: InkWell(
                    ...
                    child: Ink.image(image: NetworkImage(
                        'https://th.bing.com/th/id/R.1d0152d8269d9321cd79397ea3a60087?rik=6ET6e5KJ0g4mlQ&riu=http%3a%2f%2fwallpapercave.com%2fwp%2fjaqkcSk.jpg&ehk=KbIJHXEuGM6DwLfdBm%2bgY6J%2ffcryFKbscLEZET4Mnmo%3d&risl=&pid=ImgRaw&r=0'
                    ),
                      width: 350,
                      height: 208,
                      child: Align(
                        child: Text('MISSION 1', style: TextStyle(color: Colors
                            .white, fontSize: 50),),
                ...
                Container(
                  child: InkWell(
                    ...
                    child: Ink.image(image: NetworkImage(
                        'https://doctor-john.net/wp-content/uploads/2017/02/headphones-in-bluegreennew-e1516902785138.jpg'
                    ),
                      width: 350,
                      height: 221,
                      child: Align(
                        child: Text('MISSION 2', style: TextStyle(color: Colors
                            .red, fontSize: 50),),
                        alignment: Alignment.center,),
                ...
                Container(
                  child: InkWell(
                    ...
                    child: Ink.image(image: NetworkImage(
                      ...
                      height: 200,
                      child: Align(
                        child: Text('MISSION 3', style: TextStyle(color: Colors
                            .lightGreen, fontSize: 50),),
                        alignment: Alignment.center,),
