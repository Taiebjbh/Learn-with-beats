...
import 'package:finale/provider/mission_provider1.dart';
...
class _HomeScreenState extends State<HomeScreen>
  ...
  final List<String> lisss = [
    '10','2','22','7','88','3','8','71','55','3','1','9',
  ];
  void play() async{
    await audioPlayer.play(AssetSource("wakemeup.mp3"));
  }
  void play_1() async{
    ...
    return Positioned(
      ...
      child: Container(
        child: Row(mainAxisAlignment: MainAxisAlignment.center, children: [
          ...
          _tileHorizontalLine(
            point >= 27 ? Colors.green : Colors.deepOrange,),
          _tileWidget(Icons.star,
              color: point >= 27 ? Colors.deepOrange : Colors.green),
        ]),
      ),
    );
  }
