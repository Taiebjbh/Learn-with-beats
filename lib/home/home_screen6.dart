...
import 'package:finale/hard.dart';
import 'package:finale/provider/game_state.dart';
import 'package:finale/provider/mission_provider6.dart';
...
class _HomeScreenState extends State<HomeScreen>
  ...
  final List<String> lisss = [
    'orange','banane','kiwi','abrico','avocat','fraise','pomme','mangue','Melon','poire',
  ];

  void play() async{
    await audioPlayer.play(AssetSource("countingstars.mp3"));
  }
  void play_1() async{
    ...
    return Positioned(
      ...
      child: Container(
        child: Row(mainAxisAlignment: MainAxisAlignment.center, children: [
          ...
          _tileHorizontalLine(
              point >= 15 ? Colors.green : Colors.deepOrange),
          _tileWidget(Icons.star,
              color: point >= 15 ? Colors.deepOrange : Colors.green),
          _tileHorizontalLine(
            point >= 19 ? Colors.green : Colors.deepOrange,),
          _tileWidget(Icons.star,
              color: point >= 19 ? Colors.deepOrange : Colors.green),
        ]),
      ),
    );
  }
